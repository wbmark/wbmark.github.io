var Dashboard = function() {
    ...
    return {
        ...
        initJQVMAP: function() {
            ...
            Swell.addResizeHandler(function() {
        ...
        initCalendar: function() {
            ...
            $('#calendar').fullCalendar({ //re-initialize the calendar
                ...
                events: [{
                    ...
                    backgroundColor: Swell.getBrandColor('yellow')
                }, {
                    title: 'Long Event',
                    start: new Date(y, m, d - 5),
                    end: new Date(y, m, d - 2),
                    backgroundColor: Swell.getBrandColor('blue')
                }, {
                    title: 'Repeating Event',
                    start: new Date(y, m, d - 3, 16, 0),
                    allDay: false,
                    backgroundColor: Swell.getBrandColor('red')
                }, {
                    title: 'Repeating Event',
                    start: new Date(y, m, d + 6, 16, 0),
                    allDay: false,
                    backgroundColor: Swell.getBrandColor('green')
                }, {
                    title: 'Meeting',
                    ...
                    backgroundColor: Swell.getBrandColor('grey'),
                    allDay: false
                }, {
                    title: 'Birthday',
                    start: new Date(y, m, d + 1, 19, 0),
                    end: new Date(y, m, d + 1, 22, 30),
                    backgroundColor: Swell.getBrandColor('purple'),
                    allDay: false
                }, {
        ...
        initEasyPieCharts: function() {
            ...
            $('.easy-pie-chart .number.transactions').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: Swell.getBrandColor('yellow')
            });
            ...
            $('.easy-pie-chart .number.visits').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: Swell.getBrandColor('green')
            });
            ...
            $('.easy-pie-chart .number.bounce').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: Swell.getBrandColor('red')
            });
        ...
        initChat: function() {
            ...
            $('body').on('click', '.message .name', function(e) {
                ...
                Swell.scrollTo(input); // scroll to input if needed
            });
