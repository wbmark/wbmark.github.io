...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Swell.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function(color) {
            var color_ = (Swell.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (Swell.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", Swell.getGlobalCssPath() + file + ".min.css");
